 ...
 * 
 * Code provided by course staff for TTK4155
 */
...
/**
* @brief Return the time since the device was started.
 */
uint64_t time_now(void);


/**
* @brief Convert standard wall time units to ticks
 */
...
/**
* @brief Convert ticks to wall time units
 */
...
/**
* @brief Spins the CPU (delays) for a duration
* Example:
...
/**
* @brief Spins the CPU (delays) until some time after device start
 */
void time_spinUntil(uint64_t then);


/**
* @brief Performs a body periodically
* Example:
...
/**
* @brief Split ticks into human-readable form
 */
Time time_split(uint64_t t);


/**
* @brief Convert human-readable time into ticks
*/
