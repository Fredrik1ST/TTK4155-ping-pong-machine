 ...
 * @file can.h
 * 
 * @brief CAN Bus functionality for ATSAM3X8E
 * 
...
/**
 * @struct Initialization parameters for CAN
...
/**
* @brief Initialize CAN bus, with bit timings and optional interrupt
...
/**
 * @brief Strict-aliasing-safe reinterpret-cast
*/
...
/**
* @brief Send a CAN message on the bus.
...
/**
* @brief Print a CAN message (using `printf`)
*/
